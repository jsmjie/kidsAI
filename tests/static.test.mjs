...
assert.match(route, /openai\.tools\.webSearch/);
assert.match(route, /OPENAI_ENABLE_WEB_SEARCH/);
assert.match(route, /OPENAI_WEB_SEARCH_ALLOWED_DOMAINS/);
assert.match(route, /stepCountIs\(5\)/);
assert.match(route, /forceWebSearch/);
assert.match(route, /const shouldUseWebSearch/);
...
assert.match(chatPage, /forceWebSearch/);
...
assert.match(envExample, /OPENAI_ENABLE_WEB_SEARCH=false/);
assert.match(envExample, /OPENAI_WEB_SEARCH_ALLOWED_DOMAINS=/);
assert.match(readme, /Neon Postgres/);
assert.match(readme, /chat_sessions/);
assert.match(readme, /OPENAI_ENABLE_WEB_SEARCH=true/);
assert.match(readme, /web_search/);
